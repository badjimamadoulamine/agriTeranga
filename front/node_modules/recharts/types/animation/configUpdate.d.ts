...
declare const _default: <T extends Record<string, number>>(from: T, to: T, easing: EasingFunction, duration: number, render: (currentStyle: T) => void, timeoutController: TimeoutController) => StartAnimationFunction;
