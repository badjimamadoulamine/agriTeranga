...
export declare function computeBarRectangles({ layout, barSettings: { dataKey, minPointSize: minPointSizeProp }, pos, bandSize, xAxis, yAxis, xAxisTicks, yAxisTicks, stackedData, displayedData, offset, cells, parentViewBox, }: {
...
declare function BarFn(outsideProps: Props): React.JSX.Element;
export declare const Bar: React.MemoExoticComponent<typeof BarFn>;
export {};
