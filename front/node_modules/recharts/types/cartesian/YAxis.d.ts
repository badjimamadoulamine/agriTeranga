...
export declare const yAxisDefaultProps: {
    ...
    readonly scale: import("../util/types").ScaleType | import("../util/ChartUtils").RechartsScale;
    readonly tickCount: number;
    readonly type: import("../util/types").AxisDomainType;
    readonly width: YAxisWidth;
    readonly yAxisId: 0;
};
export declare const YAxis: React.MemoExoticComponent<(outsideProps: Props) => React.JSX.Element>;
export {};
