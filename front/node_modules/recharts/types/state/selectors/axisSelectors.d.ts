...
export declare const combineDomainOfStackGroups: (stackGroups: AllStackGroups | undefined, { dataStartIndex, dataEndIndex }: ChartDataState, axisType: XorYorZType, domainFromUserPreference: NumberDomain | undefined) => NumberDomain | undefined;
 ...
 * @param isPanorama
 */
export declare const selectDomainFromUserPreference: (state: RechartsRootState, axisType: XorYorZType, axisId: AxisId) => NumberDomain | undefined;
export declare const selectDomainOfStackGroups: ((state: import("redux").EmptyObject & {
    ...
    resultFunc: (resultFuncArgs_0: AllStackGroups, resultFuncArgs_1: ChartDataState, resultFuncArgs_2: any, resultFuncArgs_3: NumberDomain) => NumberDomain;
    memoizedResultFunc: ((resultFuncArgs_0: AllStackGroups, resultFuncArgs_1: ChartDataState, resultFuncArgs_2: any, resultFuncArgs_3: NumberDomain) => NumberDomain) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
    lastResult: () => NumberDomain;
    dependencies: [(state: RechartsRootState, axisType: XorYorZType, axisId: AxisId, isPanorama: boolean) => AllStackGroups | undefined, (state: RechartsRootState) => ChartDataState, <T>(_state: RechartsRootState, axisType: T) => T, (state: RechartsRootState, axisType: XorYorZType, axisId: AxisId) => NumberDomain | undefined];
...
export declare const combineDomainOfAllAppliedNumericalValuesIncludingErrorValues: (data: ChartData, axisSettings: BaseCartesianAxis, items: ReadonlyArray<GraphicalItemSettings>, errorBars: ErrorBarsState, axisType: XorYorZType) => NumberDomain | undefined;
...
export declare const combineNumericalDomain: (axisSettings: BaseCartesianAxis, domainDefinition: AxisDomain | undefined, domainFromUserPreference: NumberDomain | undefined, domainOfStackGroups: NumberDomain | undefined, dataAndErrorBarsDomain: NumberDomain | undefined, referenceElementsDomain: NumberDomain | undefined, layout: LayoutType, axisType: XorYorZType) => NumberDomain | undefined;
