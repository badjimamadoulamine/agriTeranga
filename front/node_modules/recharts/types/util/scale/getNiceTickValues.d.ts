 ...
 * @return array of ticks
 */
declare function getNiceTickValuesFn([min, max]: NumberDomain, tickCount?: number, allowDecimals?: boolean): number[];
/**
 ...
 * @return array of ticks
 */
declare function getTickValuesFixedDomainFn([min, max]: NumberDomain, tickCount: number, allowDecimals?: boolean): number[];
