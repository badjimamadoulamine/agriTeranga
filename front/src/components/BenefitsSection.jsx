...
const BenefitsSection = () => {
  const benefits = [
    ...
    },
    {
      ...
      description: 'Chez Agriterra, nous croyons au pouvoir du collectif. Nous connectons les producteurs, les consommateurs et les livreurs dans une relation de confiance et de proximité.'
    },
    {
      icon: '🥬',
