...
import logo from '../assets/logoblanc.svg' // 🔹 Mets ici le bon chemin vers ton image
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3 flex-grow">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-green-100">agriteranga@gmail.com</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-green-700 pt-6 text-center">
          <p className="text-green-100">
            © 2025 Agriteranga — Tous droits réservés
          </p>
        </div>
      </div>
    </footer>
