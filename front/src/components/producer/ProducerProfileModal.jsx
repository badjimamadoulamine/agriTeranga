...
const ProducerProfileModal = ({ isOpen, onClose, onUpdated }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // Backend should return updated user; fallback to merging known fields
      const updated = res?.data?.user || { ...user, firstName, lastName, phone }
      // If backend returns new profilePicture filename
